...
# INFO
# This program loads-in the parameter file, creates a text file with points and
# transform them in order to visualize the transformed grid. Various plotting options
# and grid discretization size are available
if __name__ == "__main__":

    # Elastix and Transformix system paths
    ...
    path_to_input = 'grid_visualization'
    path_to_output = 'grid_visualization'

    # Transform parameters file
    transform_parameters_file = 'TransformParameters.0.txt'
    ...
    transform_parameters_file = os.path.join(path_to_output, transform_parameters_file)
    ...
    im_dir_1 = 170 # x-direction (width)
    im_dir_2 = 113 # y-direction (height)
